...
const services = [
  {
    ...
    duration: '30 min',
    certification: "L'Oréal Certified",
    price: '₹149',
  },
  {
    id: 2,
    title: 'Full Body Spa',
    duration: '90 min',
    certification: "Ayurveda Certified",
    price: '₹149',
  },
  {
    id: 3,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tagsRow}>
        ...
        <View style={[styles.tag, { backgroundColor: '#D633D8' }]}>
          ...
          <Text style={styles.tagText}>Female Technician</Text>
        </View>
      ...
      <ScrollView>
        {services.map((service)=>(
            <ServicesComponrnt key={services.id} service={service}/>
        ))}
      </ScrollView>
