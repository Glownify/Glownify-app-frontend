...
const DUMMY_OUR_SERVICES = [
  { id: '1', name: 'Hair',   image: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=200' },
  { id: '2', name: 'Facial', image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=200' },
  { id: '3', name: 'Wax',    image: 'https://images.unsplash.com/photo-1519415387722-a1c3bbef716c?w=200' },
...
const DUMMY_SERVICES = {
  1: [
    { _id: 's1', name: 'Haircut & Styling', duration: '30 mins', salonPrice: 500,  homePrice: 600,  serviceMode: 'both',  image: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=200', badge: null },
    { _id: 's2', name: 'Hair Spa',          duration: '40 mins', salonPrice: 700,  homePrice: 850,  serviceMode: 'both',  image: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=200', badge: null },
    { _id: 's3', name: 'Hair Coloring',     duration: '1 hour',  salonPrice: 1200, homePrice: null, serviceMode: 'salon', image: 'https://images.unsplash.com/photo-1633681926022-84c23e8cb2d6?w=200', badge: 'Opt.' },
  ],
  2: [
    { _id: 's4', name: 'Facial Treatment', duration: '45 mins', salonPrice: 800, homePrice: 950, serviceMode: 'both', image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=200', badge: null },
    { _id: 's5', name: 'Clean Up',         duration: '30 mins', salonPrice: 500, homePrice: 600, serviceMode: 'both', image: 'https://images.unsplash.com/photo-1596704017254-9b121068ec31?w=200', badge: '*STEALDEAL' },
  ],
  3: [
    { _id: 's6', name: 'Full Arms Waxing', duration: '20 mins', salonPrice: 300, homePrice: 400, serviceMode: 'both', image: 'https://images.unsplash.com/photo-1519415387722-a1c3bbef716c?w=200', badge: null },
  ],
  4: [
    { _id: 's7', name: 'Bridal Makeup', duration: '2 hours', salonPrice: 3500, homePrice: 4000, serviceMode: 'both', image: 'https://images.unsplash.com/photo-1596704017254-9b121068ec31?w=200', badge: null },
  ],
};
...
export default function ShopDetailsScreen({ navigation, route }) {
  ...
  useEffect(() => { dispatch(fetchSalonById(salonId)); }, [dispatch, salonId]);
  ...
  const aboutText    = salonData?.about              || 'Elegance, hygiene, professionalism & premium quality. Welcome to Glamour Beauty Salon.';
  const aboutBadges  = salonData?.aboutBadges        || ['100% Hygienic & Safe', 'Experienced Beauty Experts Est. 2015'];
  ...
  const handleAddService = service => {
    ...
    const mode =
      service.serviceMode === 'salon' ? 'salon' :
      service.serviceMode === 'home'  ? 'home'  : bookingMode;
    setCartItems(prev => [...prev, { ...service, chosenMode: mode }]);
  };

  const confirmModeSelection = () => {
    if (!pendingMode || !pendingService) return;
    setCartItems(prev => [...prev, { ...pendingService, chosenMode: pendingMode }]);
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F9EFEE]" edges={['top']}>
      ...
      <CartBar
        ...
        onContinue={() => navigation.navigate('Booking', { cartItems, bookingMode })}
      />

      {/* 10. Mode selection modal */}
      <ServiceModeModal
